...
main(int argc, char **argv)
{
    ...
    while (true) {
        printState(&state);
        int currentInstruction = state.mem[state.pc];
        int opcode, regA, regB, regDest, offset;
        
        opcode = (currentInstruction >> 22) & 0x7;
        regA = (currentInstruction >> 19) & 0x7;
        regB = (currentInstruction >> 16) & 0x7;
        regDest = (currentInstruction >> 0) & 0x7;
        offset = (currentInstruction >> 0) & 0xFFFF;
